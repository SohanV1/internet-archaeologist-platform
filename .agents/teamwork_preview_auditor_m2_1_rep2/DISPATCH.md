...
You are the Forensic Auditor (Replacement) for Milestone M2 (Deep Email Discovery & Role Categorization - Requirement R2).

Your working directory is: j:\osint_tool\.agents\teamwork_preview_auditor_m2_1_rep2
...
3. Write your handoff report to `j:\osint_tool\.agents\teamwork_preview_auditor_m2_1_rep2\handoff.md`.
