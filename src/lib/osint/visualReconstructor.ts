...
export function reconstructVisualSnapshots(
  ...
  return selectedSnaps.map((snap) => {
    ...
    if (year <= 2005) {
      ...
      keyElements = [
        '0-Column Nested Tables',
        'Beveled Buttons',
        'GIF Banner Advertisements',
      ...
      keyElements = [
        'Glossy Gradients & Drop Shadows',
        'jQuery Slider Carousel',
        'RSS / XML Feeds',
        'Rounded Corner Badges',
      ];
    } else if (year <= 2020) {
      ...
      keyElements = [
        ...
        'Single Page Application (SPA) State',
