/**
 * Baseline Codebase Analytics Data Structures & Computations
 * Client-safe with zero Node.js native dependencies.
 */
...
export const DEFAULT_PORTFOLIO_PROJECTS: ProjectLocStat[] = [
  {
    name: 'website',
...
export const BASE_LANGUAGES: LanguageStat[] = [
  {
    language: 'Markdown',
    extension: '.md',
    lines: 155620,
...
export const DEFAULT_TREEMAP_DATA: TreemapNode = {
...
export const DEFAULT_GIT_HISTORY: GitCommitLocEntry[] = [
  {
    hash: '1fb003c',
    date: '2026-08-16',
...
export const DEFAULT_LANGUAGE_MIX_TIMELINE: LanguageMixTimelineEntry[] = [
  {
...
export const DEFAULT_FILE_COUNT_BY_EXTENSION = [
...
export function getDefaultCodebaseAnalytics(): CodebaseAnalyticsData {
  ...
  return {
    ...
    treemapData: DEFAULT_TREEMAP_DATA,
    runtimeBreakdown: {
    ...
    gitHistory: DEFAULT_GIT_HISTORY,
    languageMixTimeline: DEFAULT_LANGUAGE_MIX_TIMELINE,
    fileCountByExtension: DEFAULT_FILE_COUNT_BY_EXTENSION,
    summary: {
      totalLoc: totalCalculatedLoc,
      totalFiles: 1259,
